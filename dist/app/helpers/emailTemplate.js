...
exports.createUserOrderShippedEmail = exports.createAdminOrderNotificationEmail = void 0;
    ...
    const itemsHtml = order.items.map((item) => {
        ...
        <tr style="border-bottom: 1px solid #eee;">
            <td style="padding: 10px 0; display: flex; align-items: center; gap: 10px;">
                ${((_a = item.product) === null || _a === void 0 ? void 0 : _a.thumbnail) ? `<img src="${item.product.thumbnail}" alt="${item.product.name}" style="width: 40px; hieght: 40px; object-fit: cover; border-radius: 4px;" />` : ''}
                <div>
                    <div style="font-weight: bold;">${((_b = item.product) === null || _b === void 0 ? void 0 : _b.name) || 'Product'}</div>
...
exports.createAdminOrderNotificationEmail = createAdminOrderNotificationEmail;
const createUserOrderShippedEmail = (order) => {
    return `
        <!DOCTYPE html>
        <html>
        <head>
        ...
        return `
                            <tr style="border-bottom: 1px solid #eee;">
                                ...
                                <td style="padding: 10px 0; text-align: right;">${item.quantity} x ৳${(_c = item.variant.discountPrice) !== null && _c !== void 0 ? _c : item.variant.price}</td>
                            </tr>
                        `;
    }).join('')}
                    </table>
...
exports.createUserOrderShippedEmail = createUserOrderShippedEmail;
