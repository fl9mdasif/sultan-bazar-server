        ...
        <div className="min-h-screen flex" style={{ background: "#FAFAF8" }}>
            ...
            <div className="flex-1 flex items-center justify-center px-6 py-12 lg:px-16">
                <div className="w-full max-w-md">
                    ...
                    {/* Social */}
                    <button
                        className="disabled w-full flex items-center justify-center gap-3 border border-gray-200 rounded-xl py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors bg-white"
                    >
